...
- **Deployment**: Via [clasp](https://github.com/google/clasp) (Command Line Apps Script). CI/CD is configured in `.github/workflows/deploy.yml` using GitHub Actions to push and deploy on every merge to `master`.
